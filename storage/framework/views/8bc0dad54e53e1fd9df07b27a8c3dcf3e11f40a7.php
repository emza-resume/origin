                ...
                <div class="container">
                    <div class="w-sm-100 w-lg-50 col-sm-12 col-md-12 col-lg-6 px-0  float-right">
                        <div class="border-blue box-custom-shadow rounded p-3 position-relative top-9 bg-section">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" id="formMobile" name="formMobile" placeholder="Example: +989226681982"
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="formWebsite" name="formWebsite" placeholder="Example: reza-ahmadi"
                                    value="<?php echo e(old('formWebsite')); ?>" maxlength="40" pattern="[A-Za-z0-9](?:[A-Za-z0-9\-]{0,61}[A-Za-z0-9])?"
...
<?php echo $__env->make('master.layout-out', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/emzaapp1/mysite/resources/views/form-fast-english.blade.php ENDPATH**/ ?>