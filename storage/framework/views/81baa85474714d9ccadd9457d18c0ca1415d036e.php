    ...
    <table style="width:100%;height:100%;" class="font13">
            ...
            <td colspan="2" valign="top" style="height:154px;padding:20px;">
                ...
                <table>
                    <tr  style="background:white;border-right:5px solid yellow;">
                        <td>
                            <span style="float:right;margin:10px;color:black;" class="Yekan"><?php echo e($getbases->BaseName); ?> <?php echo e($getbases->BaseFamily); ?></span>
                            <span style="float:right;margin:10px;color:black;" class="Yekan"><?php echo e($getbases->BaseMarital); ?></span>
                        </td>
                        <td>
                            <span style="float:right;margin:10px;"><span style="color:black;font-weight:bold;">وضعیت سربازی: </span><span class="Yekan" style="color:black;"><?php echo e($getbases->BaseSolider); ?></span>
                        </td>
                    </tr>
                    <tr style="background:white;border-right:5px solid red;">
                        <td>
                            <span style="float:right;margin:10px;"><span style="color:black;font-weight:bold;">حرفه: </span><span class="Yekan" style="color:black;"><?php echo e($getbases->BaseWorkTitle); ?></span>
        ...
        <tr>
            ...
            <div style="padding:10px;">
                <div style="margin:10px;text-align:right;color:black;"><span style="color:black;font-weight:bold; " class="Yekan">نام زبان: </span><?php echo e($getlangs->LangName); ?></div>
                ...
                <div style="max-height:68px;height:85px;color:black">
                    <div style="margin:10px;text-align:right;color:black" class="Yekan"><span style="color:black;font-weight:bold;" >عنوان پایان نامه: </span> <?php echo e($getprojects->ProjectTitle); ?>
                ...
                <div style="margin:10px;text-align:right;color:black" class="Yekan"><span style="font-weight:bold;color:black;">مقطع: </span><?php echo e($getedus->EduSection); ?></div>
                <div style="margin:10px;text-align:right;color:black" class="Yekan"><span style="font-weight:bold;color:black;">رشته: </span><?php echo e($getedus->EduMajor); ?></div>
                <div style="margin:10px;text-align:right;color:black" class="Yekan"><span style="font-weight:bold;color:black;">گرایش: </span><?php echo e($getedus->EduOrientation); ?></div>
                <div style="margin:10px;text-align:right;color:black" class="Yekan"><span style="font-weight:bold;color:black;">موسسه: </span><?php echo e($getedus->EduLnstitute); ?></div>
                ...
                <div style="margin:10px;text-align:right;color:black" class="Yekan"><span style="font-weight:bold;color:black;">سمت: </span><?php echo e($getworks->WorkPost); ?></div>
                <div style="margin:10px;text-align:right;color:black" class="Yekan"><span style="font-weight:bold;color:black;">نوع مرکز: </span><?php echo e($getworks->WorkCenter); ?></div>
                <div style="margin:10px;text-align:right;color:black" class="Yekan"><span style="font-weight:bold;color:black;">نام مرکز: </span><?php echo e($getworks->WorkTitleCenter); ?></div>
                <div style="margin:10px;text-align:right;color:black" class="Yekan"><span style="font-weight:bold;color:black;">چگونگی همکاری: </span><?php echo e($getworks->WorkCooperation); ?></div>
                </div>
            </td>
            <td valign="top" style="width:50%">
                ...
                <div style="margin:10px;text-align:right;color:black;" class="Yekan"><span style="font-weight:bold;color:black;">نوع دوره: </span><?php echo e($getcourses->CoursesType); ?></div>
                <div style="margin:10px;text-align:right;color:black;" class="Yekan"><span style="font-weight:bold;color:black;">عنوان دوره: </span><?php echo e($getcourses->CoursesTitle); ?></div>
                <div style="margin:10px;text-align:right;color:black;" class="Yekan"><span style="font-weight:bold;color:black;">نام موسسه: </span><?php echo e($getcourses->CoursesInstitute); ?></div>
                </div>
...
<?php /**PATH /home/emzaapp1/mysite/resources/views/download/template/blue.blade.php ENDPATH**/ ?>