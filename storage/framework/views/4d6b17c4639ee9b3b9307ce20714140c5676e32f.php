<table align="center" class="border border-dark mt-5" style="background-size:cover;width:21cm;height:29cm;background:url('<?php echo e(asset('img/back-default.jpg')); ?>');background-size:cover;">
    ...
    <tr >
        ...
        <tr class="border border-dark border-bottom-1 border-top-0">
            <td colspan="4" class="text-left pl-3">دارای مدرک <?php echo e($getedus->EduSection); ?> <?php echo e($getedus->EduMajor); ?> گرایش <?php echo e($getedus->EduOrientation); ?> از <?php echo e($getedus->EduLnstitute); ?> . معدل: <?php echo e($getedus->EduAverage); ?> از 20.00</td>
        </tr>
...
<?php /**PATH /home/emzaapp1/mysite/resources/views/download/template/default.blade.php ENDPATH**/ ?>