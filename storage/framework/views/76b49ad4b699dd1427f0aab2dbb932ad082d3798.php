  ...
  <div class="modal-dialog modal-lg modal-dialog-centered" style="max-width: 860px;">
    <div class="modal-content " style="width:218mm;height:320mm;overflow-x: scroll;background: #f8f9fa;">
      ...
      <div class="modal-body mx-auto bg-light">
        ...
        <!-- صفحه رزومه A4 -->
        <div class="border bg-white" style="width:210mm;height:279mm;<?php if(@$getbases->Background != ''): ?>background:url(<?php echo e(asset(@$getbases->Background)); ?>) !important;background-size: cover !important;<?php endif; ?>">
...
</div><?php /**PATH C:\xampp\mysite\resources\views/component/preview.blade.php ENDPATH**/ ?>