    ...
    <table class="table table-dark shadow table-striped m-4 w-75 mx-auto mt-5">
        ...
        <tbody>
          ...
          <tr>
            ...
            <a href="/template-selection/download/beautiful-gray-template-home" class="btn btn-primary px-5 py-3 my-5 d-block w-100 mx-auto text-white" style="margin-top:100px;margin-bottom:100px;" href="#" role="button">انتقال به درگاه پرداخت بانک</a>
          </td>
          </tr>
...
<?php echo $__env->make('master.layout-out', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/emzaapp1/mysite/resources/views/pay-gray-home.blade.php ENDPATH**/ ?>