...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('img/final-logo-small.png')); ?>" type="image/x-icon" />
    <title> وب سایت نمونه فارسی حرفه ای</title>
    <style>
        ...
        <header class="header" style="right:0">
            <div class="header-content">
                <div class="profile-picture-block">
                    <div class="my-photo">
                        <img src="<?php echo e(asset('img/my1373.png')); ?>" class="img-fluid" style="box-sizing: border-box;width:70px" alt="Reza Ahmadi">
                    </div>
                </div>
                <!-- Header Head -->
                <div class="site-title-block">
                    <div class="site-title">رضا احمدی</div>
                    <div class="type-wrap">
...
"> خانه&nbsp;&nbsp;<img width="20" height="20" src="<?php echo e(asset('img/site/home.png')); ?>"></a></li>
                        <li style="
    padding-left: 0px;
    padding-right: 30px;
...
"> درباره من&nbsp;&nbsp;<img width="20" height="20" src="<?php echo e(asset('img/site/about.png')); ?>"></a></li>
                        <li style="
    padding-left: 0px;
    padding-right: 30px;
"><a href="#resume" style="
...
"> رزومه&nbsp;&nbsp;<img width="20" height="20" src="<?php echo e(asset('img/site/curriculum.png')); ?>"></a></li>
                        <li>
                    </ul>
                    <!-- /Main menu -->
                </div>
        ...
        <div class="responsive-header">
            <div class="responsive-header-name">
                <img class="responsive-logo" src="<?php echo e(asset('img/my1373.png')); ?>" /> رضا احمدی </div>
            <span class="responsive-icon"><img width="20" height="20" src="<?php echo e(asset('img/site/menu.png')); ?>"></span>
        </div>
        <!-- /Mobile Header -->
        <!-- Main Content Pages -->
                        ...
                        <div class="section-content">
                            ...
                            <div class="row pb-30">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                    <h3 class="text-right">رضا احمدی</h3>
                                    <span class="about-location text-right">یزد - جمهوری اسلامی ایران</span>
                                        ...
                                        <div class="main-timeline">
                                            ...
                                            <div class="timeline currecnt">
                                                <div class="timeline-icon">
                                                    <img src="<?php echo e(asset('img/final-logo-mediun.png')); ?>" alt="امضا رزومه ساز آنلاین">
                                                </div>
                                            ...
                                            <div class="timeline ">
                                                <div class="timeline-icon">
                                                    <img src="<?php echo e(asset('img/site/paziresh24.png')); ?>" alt="پذیرش 24">
                                                </div>
                                                <div class="timeline-content">
                                                    <span class="date">
                                                         </span>
...
مهارت های زبان
                                                    ...
                                                    <div class="skills-items skills-progressbar">
                                                        <div class="skill-item">
                                                            <h4>انگلیسی</h4>
                                                            <div class="progress">
                                                                <div class="progress-bar wow fadeInLeft" data-progress="40%" style="width: 40%;" data-wow-duration="1.5s" data-wow-delay="1.2s"> </div>
                                                            </div>
                                                            <span>40%</span>
                                                        </div>
                                                        <div class="skill-item">
                                                            <h4>عربی</h4>
                                                            <div class="progress">
                                                                <div class="progress-bar wow fadeInLeft" data-progress="35%" style="width: 35%;" data-wow-duration="1.5s" data-wow-delay="1.2s"> </div>
                                                            </div>
                                                            <span>35%</span>
                                                        </div>
                                    ...
                                    <div class="pt-30">
                                        ...
                                        <div class="main-timeline">
                                            ...
                                            <div class="timeline ">
                                                <div class="timeline-icon">
                                                    <img src="<?php echo e(asset('img/site/iju.png')); ?>" alt="دانشگاه امام جواد">
                                                </div>
                                                <div class="timeline-content">
                                                    <span class="date">
                                                        در حال تحصیل </span>
...
معدل: 17.77
                                            ...
                                            <div class="timeline ">
                                                <div class="timeline-icon">
                                                                                                        <img src="<?php echo e(asset('img/site/imamali.jpg')); ?>" alt="دانشگاه امام علی">
                                                </div>
                                                <div class="timeline-content">
                                                    <span class="date">
                                                        1390 - 1393 </span>
...
</html><?php /**PATH /home/emzaapp1/mysite/resources/views/master/site.blade.php ENDPATH**/ ?>