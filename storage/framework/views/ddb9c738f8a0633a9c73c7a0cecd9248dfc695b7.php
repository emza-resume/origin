...
<div class="container">
    <div class="row">
        <div style="border-width: 2px !important;" class="jumbotron bg-light w-100 p-0 pb-1 p-sm-1 mt-5 mx-3 border border-info rounded-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="/delete-image-avatar" enctype="multipart/form-data" class="needs-validation mt-5" novalidate>
                                ...
                                <img src="<?php echo e($getbases->BaseAvatar); ?>" name="fileAvatar" alt="عکس نمایه در سامانه امضا" width="300" height="400" class="mx-auto d-block border border-primary">
            ...
            <form method="POST" action="/update-form-cv-fast-persian" enctype="multipart/form-data" class="needs-validation mt-5" novalidate>
                <?php echo csrf_field(); ?>
                    ...
                    <div class="w-sm-100 w-lg-50 col-sm-12 col-md-12 col-lg-6 float-left">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="custom-select rounded-right  border-left-success" name="ّformSoldier" id="ّformSoldier" value="<?php echo e(old('formSoldier')); ?>" required>
                                ...
                                <option value="من زن هستم" <?php if($getbases->BaseSolider == "من زن هستم"): ?> selected <?php endif; ?>>من زن هستم</option>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" id="formWebsite" name="formWebsite" value="<?php echo e($getbases->BaseWebsite); ?>" maxlength="40" pattern="[A-Za-z0-9](?:[A-Za-z0-9\-]{0,61}[A-Za-z0-9])?" class="form-control text-right rounded-right ">
                    ...
                    <div class="w-sm-100 w-lg-50 col-sm-12 col-md-12 col-lg-6  float-left">
                        ...
                        <div class="border border-dark rounded p-2 position-relative top-9">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select border-left-info rounded-right" name="formWorkcenter" id="formWorkcenter" value="<?php echo e(old('FormEduSection')); ?>">
                                    ...
                                    <option value="حوزه علمیه" <?php if($getworks->WorkCenter == "حوزه علمیه"): ?> selected <?php endif; ?>>حوزه علمیه</option>
                        ...
                        <div class="w-sm-100 w-lg-50 col-sm-12 col-md-12 col-lg-12 float-left w-100 px-0">
                            <div class="input-group ml-0">
                                ...
                                <a href="/template" class="btn btn-danger mx-1"> بازگشت </a>
                            </div>
                            <br>
                            <br>
                        </div>
...
<?php echo $__env->make('master.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/emzaapp1/mysite/resources/views/form-edit-fast-persian.blade.php ENDPATH**/ ?>