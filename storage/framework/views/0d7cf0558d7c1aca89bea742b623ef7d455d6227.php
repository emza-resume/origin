<div class="container-fluat" style="position:relative;top:-20px;">
    <div class="row p-5" style="position:relative;top:6px;width:auto;margin-left: 0px;margin-right: 0px;padding-bottom: 0px !important;">
        <div id="property1" class="col-lg-3 col-md-6 col-sm-12 my-4"><img
                src="<?php echo e(asset('img/icons/paper-plane.svg')); ?>" id="fast" width="64" height="64"
        ...
        <div id="property2" class="col-lg-3 col-md-6 col-sm-12 my-4"><img
                src="<?php echo e(asset('img/easy.png')); ?>" width="64" height="64"
                class="mx-auto d-block mb-3" loading="lazy">
        ...
        <div id="property3" class="col-lg-3 col-md-6 col-sm-12 my-4"><img
                src="<?php echo e(asset('img/icons/star.svg')); ?>" width="64" height="64"
                class="mx-auto d-block mb-3" loading="lazy">
        ...
        <div id="property1" class="col-lg-3 col-md-6 col-sm-12 my-4"><img
                src="<?php echo e(asset('img/icons/success.svg')); ?>" width="64" height="64"
                class="mx-auto d-block mb-3" loading="lazy">
        ...
        <div id="property2" class="col-lg-3 col-md-6 col-sm-12 my-4"><img
                src="<?php echo e(asset('img/icons/bookmark.svg')); ?>" width="64" height="64"
                class="mx-auto d-block mb-3" loading="lazy">
        ...
        <div id="property3" class="col-lg-3 col-md-6 col-sm-12 my-4"><img
                src="<?php echo e(asset('img/icons/gift.svg')); ?>" width="64" height="64"
                class="mx-auto d-block mb-3" loading="lazy">
        ...
        <div id="property3" class="col-lg-3 col-md-6 col-sm-12 my-4"><img
                src="<?php echo e(asset('img/secure-shield-shield.png')); ?>" width="64" height="64"
                class="mx-auto d-block mb-3" loading="lazy">
        ...
        <div id="property3" class="col-lg-3 col-md-6 col-sm-12 my-4"><img
                src="<?php echo e(asset('img/safe.png')); ?>" width="64" height="64"
                class="mx-auto d-block mb-3" loading="lazy">
            ...
            <p class="text-justify text-center mx-5" style="color: #013e24;font-weight: bold;font-size: 14px;">مطمئن باشید اطلاعاتی مثل اطلاعات حساب شما در اختیار شخصی ثالثی قرار
                ...
                src="<?php echo e(asset('img/down.png')); ?>" class="d-block mx-auto"
...
<?php /**PATH /home/emzaapp1/mysite/resources/views/layouts/property.blade.php ENDPATH**/ ?>