...
<div class="container">
    <div class="row">
        ...
        <div style="background:white !important;" class="jumbotron bg-light w-100 p-0 p-sm-1 mt-0 mx-3   rounded-lg">
            <br>
            <img class="mx-auto d-block position-relative" style="top: 13px;" src="<?php echo e(asset('img/title.jpg')); ?>" />
            ...
            <form method="POST" action="/save-form-cv-fast-persian" enctype="multipart/form-data" class="needs-validation mt-5" novalidate>
                ...
                <div class="container">
                    <div class="w-sm-100 w-lg-50 col-sm-12 col-md-12 col-lg-6 px-0  float-left">
                        <div class="border-blue rounded p-3 position-relative top-9 bg-section box-custom-shadow">
                            ...
                            <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-purple border-purple  text-white" style="height:36px">آواتار</span>
                                    </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" id="formName" name="formName" value="<?php echo e(old('formName')); ?>" class="form-control rounded-right border-left-success form-black-color" placeholder="مثال: رضا" required>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" id="formFamily" name="formFamily" value="<?php echo e(old('formFamily')); ?>" class="form-control rounded-right  border-left-success" placeholder="مثال: احمدی قوام آباد" required>
                            <div class="invalid-feedback p-2 bg-danger text-white font-weight-bold rounded">لطفا این فیلد را پر کنید.</div>
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                            ...
                            <div class="custom-control custom-radio">
                                <input type="radio" class="shadow custom-control-input ml-1 pt-2 d-flex d-inline-flex align-self-center position-relative top-3" name="formMarital" id="formMarital_1" value="<?php echo e(old('formMarital')); ?>"  value="مجرد">
                                <label class="custom-control-label ml-2 mt-2 d-flex d-inline-flex align-self-center" for="formMarital_1">مجرد</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio" class="shadow custom-control-input ml-1 pt-2 d-flex d-inline-flex align-self-center position-relative top-3" name="formMarital" id="formMarital_2" value="<?php echo e(old('formMarital')); ?>" value="متاهل">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" id="formmail" name="formmail" value="<?php echo e(old('formmail')); ?>" class="form-control text-right rounded-right border-left-success" placeholder="Example: rezaahmadiyazd@gmail.com" pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$" required>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" id="formWebsite" name="formWebsite" placeholder="Example: reza" value="<?php echo e(old('formWebsite')); ?>" maxlength="10" pattern="[a-z-A-Z]\w+" class="form-control text-right rounded-right " required>
                            &nbsp;<a href="#" class="btn btn-success" href="#">بررسی</a>
                ...
                <div class="border-blue rounded box-custom-shadow p-3 position-relative top-9 bg-section">
                    <div class="badge-pill position-relative bg-blue w-50 text-center text-white p-1 left-100" style="top:-20px">مهارت زبان</div>
                        <div class="input-group mb-3">
                            ...
                            <input type="text" id="formLangName" name="formlangname"  value="<?php echo e(old('formlangname')); ?>" placeholder="مثال : انگلیسی" class="form-control border-left-success rounded-right" required>
                            <div class="invalid-feedback p-2 bg-danger text-white font-weight-bold rounded">لطفا این فیلد را پر کنید.</div>
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                ...
                <div class="border-blue rounded p-3 box-custom-shadow position-relative top-9 bg-section">
                    <div class="badge-pill position-relative bg-blue w-50 text-center text-white p-1 left-100" style="top:-20px">اطلاعات تحصیلی</div>
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-purple border-purple text-white">عنوان موسسه </span>
                            </div>
...
<?php echo $__env->make('master.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\mysite\resources\views/form-fast-persian.blade.php ENDPATH**/ ?>