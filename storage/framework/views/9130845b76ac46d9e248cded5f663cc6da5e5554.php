...
<style>
  ...
  @media (max-width: 425px) and (min-width: 376px)
  {
   #A4 {
    ...
    transform: scale(0.47,0.47); /* Standard syntax */
...
<body>
<div id="A4" style="width:210mm;heigtd:297mm;display:black;margin:0 auto;padding:1cm;box-shadow:1px 1px 1px 1px black">
    <div>
...
<?php /**PATH /home/emzaapp1/mysite/resources/views/template-dynamic.blade.php ENDPATH**/ ?>