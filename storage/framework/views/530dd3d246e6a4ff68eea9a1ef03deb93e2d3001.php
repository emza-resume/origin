...
<div class="jumbotron w-100 border-2 p-xs-1 p-5 mb-6 br-4 shadow" id="divthesis" style="<?php echo $__env->yieldContent('backpanel-7'); ?>">
    <div class="form-row" id="formthesis0">
        ...
        <div class="form-group float-left m-1 m-md-3 mobile-input">
            ...
            <div class="mobile-input">
                <select d class="form-control border-dark-blue float-left mx-1" tabindex="74"
                ...
                <select d class="form-control border-dark-blue w-auto float-left mx-1" tabindex="74"
                ...
                <input min="1300" max="1400" data-score="2" tabindex="75"
                    class="form-control border-dark-blue w-auto float-left mx-1" placeholder="سال" maxlength="4"
        ...
        <div class="form-group float-left m-1 m-md-3 position-relative mobile-input topt" style="top:-5px">
            ...
            تاریخ دفاع ندارد 
            <div class="mobile-input">
                <select  class="form-control border-dark-blue float-left mx-1" tabindex="77"
                ...
                <select  class="form-control border-dark-blue w-auto float-left mx-1" tabindex="78"
                ...
                <input  min="1300" max="1400" data-score="2" tabindex="79"
                    class="form-control border-dark-blue w-auto float-left mx-1 mobile-input" placeholder="سال" maxlength="4"
...
<?php /**PATH /home/emzaapp1/mysite/resources/views/component/thesis.blade.php ENDPATH**/ ?>