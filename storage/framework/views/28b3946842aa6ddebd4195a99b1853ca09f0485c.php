        ...
        <tr>
            ...
            <td valign="top">
                ...
                <div>
                    ...
                    <img src="<?php echo e(asset('img/star.svg')); ?>" class="mt-28-circle" style="display:inline-block;width:14px;height:14px;margin:3px;float:right;">
                    <?php endfor; ?>
                    <?php for($j=5;$j>$i;$j--): ?>
                    <img src="<?php echo e(asset('img/star-null.svg')); ?>" class="mt-28-circle" style="display:inline-block;width:14px;height:14px;margin:3px;float:right;">
                    <?php endfor; ?>
                    </div> 
                    </div>
                    <?php if($i == 1): ?>
...
<?php /**PATH /home/emzaapp1/mysite/resources/views/template-dynamic-print.blade.php ENDPATH**/ ?>