                ...
                <div class="border bg-white d-black mx-auto" id="pageA4"
                    ...
                    <?php if(@$mg != ''): ?> <a
                        ...
                        class="btn btn-danger float-right p-3 mx-5 mb-5">وب‌سایت نمیخواهم!</a><br><br><br><?php else: ?> <a
                            ...
                            target="_blank" class="btn btn-secondary text-center d-block mx-auto w-25 p-2 mx-2 mb-2"
                            style="width:230px !important">چاپ</a><button type="button"
...
<?php echo $__env->make('master.layout-out', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/emzaapp1/mysite/resources/views/cv/get-with-picture.blade.php ENDPATH**/ ?>