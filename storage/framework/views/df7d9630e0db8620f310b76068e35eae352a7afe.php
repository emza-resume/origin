...
<div class="jumbotron w-100 border-2 p-xs-1 p-5 mb-6 br-4 shadow" id="divwork" style="<?php echo $__env->yieldContent('backpanel-6'); ?>">
<h5 class="text-center" style="font-size: 14px !important;position: relative;top: -15px;color:#222;margin-right: 20px;margin-left: 20px;">برای نوشتن سوابق شغلی ترتیب زمانی معکوس را رعایت کنید و از آخرین شغلی که داشتید یا دارید، شروع به نوشتن کنید.</h5>
        <!-- hidden input -->
...
<script src="<?php echo e(asset('js/add-w.js')); ?>"></script><?php /**PATH /home/emzaapp1/mysite/resources/views/component/work.blade.php ENDPATH**/ ?>