...
var myChart = new Chart(ctx, {
    type: 'bar',
    data: {
        labels: ['تعداد بازدید از صفحه‌اصلی', 'تعداد بازدیدکننده از صفحه‌اصلی', 'تعداد بازدید از ورود', 'تعداد بازدیدکننده از ورود', 'تعداد بازدید از ساخت رزومه', 'تعداد بازدیدکننده از ساخت رزومه'],
        datasets: [{
            label: 'تعداد',
            data: [<?php echo e($ci); ?>, <?php echo e($cind); ?>, <?php echo e($cl); ?>, <?php echo e($clnd); ?>, <?php echo e($cc); ?>, <?php echo e($ccnd); ?>],
            backgroundColor: [
                'rgba(216, 27, 96, 0.6)',
                'rgba(216, 27, 96, 0.6)',
                'rgba(255, 152, 0, 0.6)',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/emzaapp1/mysite/resources/views/admin/logs.blade.php ENDPATH**/ ?>