...
<div class="container">
    <div class="row">
        ...
        <br>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="/delete-image-avatar-en" enctype="multipart/form-data" class="needs-validation mt-5" novalidate>
                            ...
                            <img src="<?php echo e($getbases->BaseAvatar); ?>" name="fileAvatar" alt="Avatar in website" width="300" height="400" class="mx-auto d-block border border-primary">
            ...
            <form method="POST" action="/update-form-cv-fast-english" enctype="multipart/form-data" class="needs-validation mt-5" novalidate>
                <?php echo csrf_field(); ?>
                ...
                <div class="container">
                    <div class="w-sm-100 w-lg-50 col-sm-12 col-md-12 col-lg-6  float-right">
                        ...
                        <div class="input-group mb-3">
                                ...
                                <div class="custom-file">
                                        ...
                                        <input type="file" class="custom-file-input" accept="image/x-png,image/gif,image/jpeg" id="customFile" name="img">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" id="formWebsite" name="formWebsite" value="<?php echo e($getbases->BaseWebsite); ?>" maxlength="10" pattern="[a-z-A-Z]\w+" class="form-control text-right rounded-left ">
                            <div class="input-group-prepend">
                    ...
                    <div class="w-sm-100 w-lg-50 col-sm-12 col-md-12 col-lg-6  float-left">
                        ...
                        <div class="input-group mb-3">
                                <select class="custom-select border-left-info rounded-left" name="formWorkcenter" id="formWorkcenter" style="direction:ltr !important;" value="<?php echo e(old('FormEduSection')); ?>">
                                        ...
                                        <option value="Self-employment" <?php if($getworks->WorkCenter == "Self-employment"): ?> selected <?php endif; ?>>Self_employment</option>
                    ...
                    <br>
                        ...
                        <div class="input-group mb-3" style="direction:ltr;">
                                ...
                                <a href="/template-en" class="btn btn-danger mx-1">Back</a>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('master.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/emzaapp1/mysite/resources/views/form-edit-fast-english.blade.php ENDPATH**/ ?>