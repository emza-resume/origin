    ...
    <tr>
        <td valign="top" style="height:200px;width:259px;overflow-x: hidden;">
            <table cellspacing="0" style="height:200px;position: relative;top: -4px;width:100%;background:#28204c;left: 1px;">
                ...
                <tr style="background:#443782;">
                    <td>
                        <div class="text-left text-white m-2 ml-4" style="font-size:15px;">
                ...
                <tr style="background:#443782;">
                    <td>
                        <div class="text-left text-white m-2 ml-4" style="font-size:15px;"><?php echo e($getbases->BaseMobile); ?>
                ...
                <tr style="background:#443782;">
                    <td>
                        <div class="text-left text-white m-2 ml-4" style="font-size:15px;"><?php echo e($getbases->BaseTel); ?>
                ...
                <tr style="background:#443782;">
                    <td>
                        ...
                        <?php else: ?>
                        <div class="text-left text-white mt-2 mb-5 ml-4" style="font-size:15px;"><?php echo e($getbases->BaseWebsite); ?>.emza.app
...
<?php /**PATH /home/emzaapp1/mysite/resources/views/download/template/gray.blade.php ENDPATH**/ ?>