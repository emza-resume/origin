...
<body>
    <div class="box">
        <div id="L1" class="boxp" style="background: #f1c40f;left:0px;top:0px;">
            ...
            <div class="pbox">
            <p class="subtext">شماره موبایل : <?php echo e($getbases->BaseMobile); ?></p>
            <p class="subtext">تلفن تماس : <?php echo e($getbases->BaseTel); ?></p>
            <p class="subtext">ایمیل : <?php echo e($getbases->BaseEmail); ?></p>
            </div>
        </div>
        <div id="L2" class="boxp" style="background: #16a085;left:327px;top: -327px;">
            ...
            <div class="pbox">
            <p class="subtext">نام : <?php echo e($getbases->BaseName); ?></p>
            <p class="subtext">نام‌خانوادگی : <?php echo e($getbases->BaseFamily); ?></p>
            <p class="subtext">وضعیت تاهل : <?php echo e($getbases->BaseMarital); ?></p>
            <p class="subtext">وضعیت سربازی : <?php echo e($getbases->BaseSolider); ?></p>
            </div>
        </div>
...
<span class="fa fa-star"></span></p> </p>
        ...
        <div id="L6" class="boxp" style="background: #f39c12;left: 654px;top: -1308px;">
            ...
            <p class="subtext">مقطع : <?php echo e($getedu->EduSection); ?></p>
            <p class="subtext">رشته : <?php echo e($getedu->EduMajor); ?>  </p>
            <p class="subtext">گرایش : <?php echo e($getedu->EduOrientation); ?> </p>
            <p class="subtext">عنوان موسسه : <?php echo e($getedu->EduLnstitute); ?>     </p>
            <p class="subtext">معدل : <?php echo e($getedu->EduAverage); ?></p>
            </div>
        </div>
        ...
        <div id="L11" class="boxp" style="background: #2c3e50;left: 654px;top: -1962px;">
            <div class="headbox" style="background: #161e27;">سن</div>
                                    <div class="pbox">
            <p class="subtext" > تاریخ تولد : <?php echo e($getbases->BaseBirthdate); ?> </p>
            <br>
            <p class="subtext" style="    text-align: center;
    font-size: 24px;"> <?php echo e($old); ?>  ساله </p>
            </div>
        </div>
        <div id="L12" class="boxp" style="background: #e74c3c;left: 327px;top: -2289px;">
            <div class="headbox" style="background: #bd3f32;">حرفه</div>
                        <div class="pbox">
            <p class="subtext" style="font-size:26px;text-align:center"><?php echo e($getbases->BaseWorkTitle); ?></p>
            </div>
        </div>
...
</html><?php /**PATH /home/emzaapp1/mysite/resources/views/master/site-fast.blade.php ENDPATH**/ ?>