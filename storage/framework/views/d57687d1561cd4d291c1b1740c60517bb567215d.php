...
<div class="jumbotron w-100 border-2 p-xs-1 p-5 mb-6 br-4 shadow" id="divjum" style="<?php echo $__env->yieldContent('backpanel-2'); ?>">
<h5 class="text-center" style="font-size: 14px !important;position: relative;top: -15px;color:#222;margin-right: 20px;margin-left: 20px;">برای نوشتن سوابق تحصیلی در رزومه، همیشه از بالاترین مدرک خود شروع به نوشتن کنید.</h5>
    <div class="form-row" id="form0">
        ...
        <div class="form-group float-left m-1 m-md-3 mobile-input" style="min-width: 170px;">
            ...
            <datalist id="FSlist[0]" style="direction:rtl;">
        ...
        <div class="form-group float-left m-1 m-md-3 mobile-input" style="min-width: 170px;">
            ...
            <datalist id="listUniversity[0]" style="direction:rtl;">
...
<?php /**PATH /home/emzaapp1/mysite/resources/views/component/education.blade.php ENDPATH**/ ?>