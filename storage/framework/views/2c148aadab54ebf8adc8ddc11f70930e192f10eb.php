...
<body>
    <div class="box">
        ...
        <div id="L3" class="boxp" style="background: #1abc9c;left: 654px;top: -654px;">
            ...
            <div><img width="200" height="200px" src="http://emza.local/img/upload/1587382721my1373.png" /></div>
        </div>
    ...
    <audio controls="" autoplay="" name="media" style="display:none;"><source src="http://emza.local/music/back.mp3" type="audio/mpeg"></audio>

</body>

</html><?php /**PATH C:\xampp\mysite\resources\views/master/site-fast-persian.blade.php ENDPATH**/ ?>