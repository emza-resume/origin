...
<div style="width:21cm;height:29.7cm;border:1px solid black;margin:0 auto;padding:20px;background:url('<?php echo e(asset('img/blue-light.jpg')); ?>');background-repeat:no-repeat;background-size: cover;background-size: 21cm 29.7cm;">
    ...
    <tr>
        <td valign="top">
            ...
            <div style="max-height:68px;height:85px;">
                <div style="margin:10px;text-align:left"><span style="font-weight:bold;">Title: </span>
                <?php echo e($getprojects->ProjectTitle); ?>

                </div>
                <div style="margin:10px;text-align:left"><span style="font-weight:bold;">Defense Date: </span>
                    <?php echo e($getprojects->ProjectDate); ?>
        ...
        <td valign="top" style="width:50%">
            ...
            <div style="margin:10px;text-align:left">
                ...
                <img src="<?php echo e(asset('img/star-null-blue.png')); ?>" style="" width="20" height="20" alt="">
                <?php endfor; ?>
                <?php for($i = 0; $i < $getlangs->LangWritingskills; $i++): ?>
                <img src="<?php echo e(asset('img/star-blue.png')); ?>" style="" width="20" height="20" alt="">
                <?php endfor; ?>
            ...
            <div style="margin:10px;text-align:left">
                ...
                <img src="<?php echo e(asset('img/star-null-blue.png')); ?>" style="position: relative;
...
<?php /**PATH /home/emzaapp1/mysite/resources/views/blue-template-english.blade.php ENDPATH**/ ?>