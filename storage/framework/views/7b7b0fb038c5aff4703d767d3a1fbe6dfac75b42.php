...
<table class="ui red table striped">
    ...
    <?php $i = 0; ?>
      ...
      <tr class="">
        ...
        <a class="mini ui blue button" href="/administrator/restore/<?php echo e($base->Baseid); ?>" ><i style="margin-left: 0px;font-size: 13px;margin-right: 0px;" class="redo icon icon-semantic"></i></a>
    ...
    <a style="width: 162px;" class="uk-button uk-button-danger  uk-align-center" href="/administrator/real-delete/<?php echo e($base->Baseid); ?>">بله</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/emzaapp1/mysite/resources/views/admin/trash.blade.php ENDPATH**/ ?>