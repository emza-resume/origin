    ...
    <table class="table table-dark shadow table-striped m-4 w-75 mx-auto mt-5">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
            <h6>توضیحات</h6>
            <p>یک قالب بسیار زیبا و جذاب</p>
            <a href="/template-selection/download/beautiful-gray-template" class="btn btn-primary px-5 py-3 my-5 d-block w-100 mx-auto text-white" style="margin-top:100px;margin-bottom:100px;" href="#" role="button">انتقال به درگاه پرداخت بانک</a>
            
            <?php if(@$err == 1): ?>
              <div class="alert alert-danger alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert">&times;</button>
                پرداخت موفقیت آمیر نبود
              </div>
            <?php endif; ?>
          </td>
          </tr>
...
<?php echo $__env->make('master.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/emzaapp1/mysite/resources/views/pay.blade.php ENDPATH**/ ?>