...
@csrf
    <input type="hidden" name="batch" value="{{ $getbase->BaseBatch }}">
    <div style="text-align:center;margin:90px;margin-top:110px;" >
    <table style="margin: 0 auto;">
        <tr>
            <td>
                <div class="ui disabled input">
                    <input value="{{ $getbase->BaseName }} {{ $getbase->BaseFamily }}">
                </div>
            </td>
            <td>
                <span>&nbsp;&nbsp;نام</span>
        ...
        <tr>
            <td>
                <div class="ui disabled input">
                    <input value="{{ $getbase_b->BaseCity }}">
                </div>
            </td>
            <td>
                <span>&nbsp;&nbsp;شهر</span>
        ...
        <tr>
            <td>
                <div class="ui input focus">
                    <input value="{{ $getbase_b->CityLat }}"  style="text-align:center" name="lat">
                </div>
            </td>
            <td>
        ...
        <tr>
            <td>
                    <div class="ui input focus">
                        <input value="{{ $getbase_b->CityLong }}"  style="text-align:center" name="long">
                    </div>
            </td>
            <td>
