...
<div id="modal-avatar" uk-modal>
    ...
    <img style="width:320px;height:410px;" uk-toggle="target: #modal-avatar" class="uk-align-center"  src="{{ asset($getbases->BaseAvatar) }}" alt="">
...
<div class="uk-container uk-margin-medium uk-margin-auto" style="width: 850px;">
        ...
        <a href="/administrator/print-resume/{{ $getbases->BaseBatch }}" class="ui red button" style="display:inline-block;margin:0 auto;font-weight:100">
          چاپ
        </a>
        </div>
