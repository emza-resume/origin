...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('fonts/vaziren/font.css') }}" />
    <link rel="shortcut icon" href="{{ asset('img/admin/final-very-small.png') }}">
    <script src="{{ asset('js/uikit.min.js') }}"></script>
    <script src="{{ asset('js/uikit-icons.min.js') }}"></script>
    <link rel="stylesheet" href="{{ asset('Semantic-UI-1.0/dist/semantic.min.css') }}" />
...
<body class="uk-background-secondary"
    style="height: 100%;background:url({{ asset('img/admin/backmenu.png') }});">
