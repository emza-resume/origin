...
<h5 class="position-relative panel-title p-2" style="@yield('stylepanel-5');top:0px;">دوره‌های آموزشی</h5>   
<div class="jumbotron w-100 border-2 p-xs-1 p-4 mb-6 br-4 shadow" id="divcources" style="@yield('backpanel-5')">
<h5 class="text-center" style="font-size: 14px !important;position: relative;top: -15px;color:#222;margin-right: 40px;margin-left: 40px;margin-top:20px">برای نوشتن دوره‌های آموزشی ترتیب زمانی معکوس را رعایت کنید و از آخرین دوره آموزشی که داشتید یا دارید، شروع به نوشتن کنید.</h5>
        <!-- hidden input -->
        <input type="hidden" name="courcesType1Z" value="@yield('ct1')" id="courcesType1Z"/>
        <input type="hidden" name="courcesName1Z" value="@yield('cn1')" id="courcesName1Z"/>
        <input type="hidden" name="courcesYear1Z" value="@yield('cy1')" id="courcesYear1Z"/>
        <input type="hidden" name="courcesInstitutionName1Z" value="@yield('cin1')" id="courcesInstitutionName1Z"/>

        <input type="hidden" name="courcesType2Z" value="@yield('ct2')" id="courcesType2Z"/>
        <input type="hidden" name="courcesName2Z" value="@yield('cn2')" id="courcesName2Z"/>
        <input type="hidden" name="courcesYear2Z" value="@yield('cy2')" id="courcesYear2Z"/>
        <input type="hidden" name="courcesInstitutionName2Z" value="@yield('cin2')" id="courcesInstitutionName2Z"/>
        <!-- end hidden input -->
    <div class="form-row" id="formcources0">
        ...
        <div class="form-group float-left m-1 m-md-3 mobile-input" style="min-width: 220px;">
            ...
            <input type="text" name="courcesType0" list="courcesTypedata0" id="courcesType0" tabindex="60" size="29" value="@yield('cources_Type0')" class="form-control border-brown" required>
            <datalist id="courcesTypedata0">
                @foreach($getcources as $cources)
                    <option style="direction:rtl;">{{ $cources }}</option>
                @endforeach
            </datalist>   
        </div>
        ...
        <div class="form-group float-left m-1 m-md-3 mobile-input" style="min-width: 220px;">
            ...
            <input type="text" name="courcesName0"  id="courcesName0" tabindex="61" size="29" value="@yield('cources_Name0')" class="form-control border-brown" required> 
        </div>
        ...
        <div class="form-group float-left m-1 m-md-3 mobile-input" style="min-width: 170px;">
            ...
            <input type="text" name="courcesYear0" pattern="13[6-9]+[0-9]$" id="courcesYear0" value="@yield('cources_Year0')" list="courcesYearData0" tabindex="62" size="7" maxlength="4"  class="form-control border-brown text-center" required>
            <datalist id="courcesYearData0">
                @foreach($getyear as $year)
                    <option style="direction:rtl;">{{ $year }}</option>
                @endforeach
            </datalist>   
        </div>
        ...
        <div class="form-group float-left m-1 m-md-3 mobile-input" style="min-width: 200px;">
            ...
            <input type="text" name="courcesInstitutionName0" id="courcesInstitutionName0" tabindex="63" size="31" value="@yield('courcesInstitution_Name0')" class="form-control border-brown" required>
        </div>
    ...
    <script src="{{ asset('js/add-c.js') }}"></script>
