    ...
    <h5 class="position-relative panel-title p-2" style="@yield('stylepanel-8');top:0px;">پروژه</h5>
    <div class="jumbotron w-100 border-2 p-xs-1 p-4 mb-6 br-4 shadow" id="divproject" style="@yield('backpanel-8')">
    <h5 class="text-center" style="font-size: 14px !important;position: relative;top: -15px;color:#222;margin-right: 40px;margin-left: 40px;margin-top:20px">برای نوشتن پروژه‌ها ترتیب زمانی معکوس را رعایت کنید و از آخرین پروژه‌ای که داشتید یا دارید، شروع به نوشتن کنید.</h5>

        <!-- hidden input -->

        <input type="hidden" name="projectName1Z" value="@yield('pn1')" id="projecName1Z"/>
        <input type="hidden" name="projecttStartMonth1Z" value="@yield('psm1')" id="projectStartMonth1Z"/>
        <input type="hidden" name="projecttStartYear1Z" value="@yield('psy1')" id="projectStartYear1Z"/>
        <input type="hidden" name="projectEndMonth1Z" value="@yield('pem1')" id="projectEndMonth1Z"/>
        <input type="hidden" name="projectEndYear1Z" value="@yield('pey1')" id="projectEndYear1Z"/>
        <input type="hidden" name="projectEmployer1Z" value="@yield('pe1')" id="projectEmployer1Z"/>
        <input type="hidden" name="projectLink1Z" value="@yield('pl1')" id="projectLink1Z"/>

        <input type="hidden" name="projecName2Z" value="@yield('pn2')" id="projecName2Z"/>
        <input type="hidden" name="projectStartMonth2Z" value="@yield('psm2')" id="projectStartMonth2Z"/>
        <input type="hidden" name="projectStartYear2Z" value="@yield('psy2')" id="projectStartYear2Z"/>
        <input type="hidden" name="projectEndMonth2Z" value="@yield('pem2')" id="projectEndMonth2Z"/>
        <input type="hidden" name="projectEndYear2Z" value="@yield('pey2')" id="projectEndYear2Z"/>
        <input type="hidden" name="projectEmployer2Z" value="@yield('pe2')" id="projectEmployer2Z"/>
        <input type="hidden" name="projectLink2Z" value="@yield('pl2')" id="projectLink2Z"/>

        <input type="hidden" name="projecName3Z" value="@yield('pn3')" id="projecName3Z"/>
        <input type="hidden" name="projectStartMonth3Z" value="@yield('psm3')" id="projectStartMonth3Z"/>
        <input type="hidden" name="projectStartYear3Z" value="@yield('psy3')" id="projectStartYear3Z"/>
        <input type="hidden" name="projectEndMonth3Z" value="@yield('pem3')" id="projectEndMonth3Z"/>
        <input type="hidden" name="projectEndYear3Z" value="@yield('pey3')" id="projectEndYear3Z"/>
        <input type="hidden" name="projectEmployer3Z" value="@yield('pe3')" id="projectEmployer3Z"/>
        <input type="hidden" name="projectLink3Z" value="@yield('pl3')" id="projectLink3Z"/>
        ...
        <div class="form-row" id="formproject0">
            ...
            <div class="form-group float-left m-1 m-md-3 mobile-input" style="min-width: 175px;">
                ...
                <input type="text" name="projecName0" value="@yield('projectName0')" id="projecName0" tabindex="80" size="30"
            ...
            <div class="form-group float-left m-1 m-md-3 mobile-input" style="min-width: 160px;">
                ...
                <div class="mobile-input">
                    <select required class="form-control border-new-color w-auto float-left mx-1" tabindex="81"
                        ...
                        <option {{ old('projectStartMonth0')=='1' ? 'selected' : '' }} {{ @$projectmonthstart=='1' ? 'selected' : '' }} value="1">01</option>
                        <option {{ old('projectStartMonth0')=='2' ? 'selected' : '' }} {{ @$projectmonthstart=='2' ? 'selected' : '' }} value="2">02</option>
                        <option {{ old('projectStartMonth0')=='3' ? 'selected' : '' }} {{ @$projectmonthstart=='3' ? 'selected' : '' }} value="3">03</option>
                        <option {{ old('projectStartMonth0')=='4' ? 'selected' : '' }} {{ @$projectmonthstart=='4' ? 'selected' : '' }} value="4">04</option>
                        <option {{ old('projectStartMonth0')=='5' ? 'selected' : '' }} {{ @$projectmonthstart=='5' ? 'selected' : '' }} value="5">05</option>
                        <option {{ old('projectStartMonth0')=='6' ? 'selected' : '' }} {{ @$projectmonthstart=='6' ? 'selected' : '' }} value="6">06</option>
                        <option {{ old('projectStartMonth0')=='7' ? 'selected' : '' }} {{ @$projectmonthstart=='7' ? 'selected' : '' }} value="7">07</option>
                        <option {{ old('projectStartMonth0')=='8' ? 'selected' : '' }} {{ @$projectmonthstart=='8' ? 'selected' : '' }} value="8">08</option>
                        <option {{ old('projectStartMonth0')=='9' ? 'selected' : '' }} {{ @$projectmonthstart=='9' ? 'selected' : '' }}  value="9">09</option>
                        <option {{ old('projectStartMonth0')=='10' ? 'selected' : '' }} {{ @$projectmonthstart=='10' ? 'selected' : '' }} value="10">10</option>
                        <option {{ old('projectStartMonth0')=='11' ? 'selected' : '' }} {{ @$projectmonthstart=='11' ? 'selected' : '' }} value="11">11</option>
                        <option {{ old('projectStartMonth0')=='12' ? 'selected' : '' }} {{ @$projectmonthstart=='12' ? 'selected' : '' }} value="12">12</option>
                    </select>
                    ...
                    <input required min="1300" max="1399" pattern="13[0-9]+[0-9]$" data-score="2" tabindex="82"
                        ...
                        style="width: 85px !important;" list="year-list-s" id="projectStartYear0" name="projectStartYear0" value="@yield('projectStartYear_0')">
            ...
            <div class="form-group float-left m-1 m-md-3 mobile-input" style="min-width: 160px;">
                ...
                <div class="mobile-input">
                    <select required class="form-control border-new-color w-auto float-left mx-1" tabindex="83"
                        ...
                        <option value="" disabled="" selected="">ماه</option>
                        <option {{ old('projectEndMonth0')=='1' ? 'selected' : '' }} {{ @$projectmonthend=='1' ? 'selected' : '' }} value="1">01</option>
                        <option {{ old('projectEndMonth0')=='2' ? 'selected' : '' }} {{ @$projectmonthend=='2' ? 'selected' : '' }} value="2">02</option>
                        <option {{ old('projectEndMonth0')=='3' ? 'selected' : '' }} {{ @$projectmonthend=='3' ? 'selected' : '' }} value="3">03</option>
                        <option {{ old('projectEndMonth0')=='4' ? 'selected' : '' }} {{ @$projectmonthend=='4' ? 'selected' : '' }} value="4">04</option>
                        <option {{ old('projectEndMonth0')=='5' ? 'selected' : '' }} {{ @$projectmonthend=='5' ? 'selected' : '' }} value="5">05</option>
                        <option {{ old('projectEndMonth0')=='6' ? 'selected' : '' }} {{ @$projectmonthend=='6' ? 'selected' : '' }} value="6">06</option>
                        <option {{ old('projectEndMonth0')=='7' ? 'selected' : '' }} {{ @$projectmonthend=='7' ? 'selected' : '' }} value="7">07</option>
                        <option {{ old('projectEndMonth0')=='8' ? 'selected' : '' }} {{ @$projectmonthend=='8' ? 'selected' : '' }} value="8">08</option>
                        <option {{ old('projectEndMonth0')=='9' ? 'selected' : '' }} {{ @$projectmonthend=='9' ? 'selected' : '' }} value="9">09</option>
                        <option {{ old('projectEndMonth0')=='10' ? 'selected' : '' }} {{ @$projectmonthend=='10' ? 'selected' : '' }} value="10">10</option>
                        <option {{ old('projectEndMonth0')=='11' ? 'selected' : '' }} {{ @$projectmonthend=='11' ? 'selected' : '' }} value="11">11</option>
                        <option {{ old('projectEndMonth0')=='12' ? 'selected' : '' }} {{ @$projectmonthend=='12' ? 'selected' : '' }} value="12">12</option>
                    </select>
            ...
            <div class="form-group float-left m-1 m-md-3 mobile-input" style="min-width: 175px;">
                ...
                <input type="text" name="projectEmployer0" id="projectEmployer0" value="@yield('projectEmployer_0')" tabindex="85" size="25"
            ...
            <div class="form-group float-left m-1 m-md-3 mobile-input" style="min-width: 175px;">
                ...
                <input type="url" name="projectLink0" id="projectLink0" value="@yield('projectLink_0')" tabindex="86" size="37"
                    class="form-control border-new-color">
            </div>
        </div>
    </div>
...
<script src="{{ asset('js/add-p.js') }}"></script>
