    ...
    <h5 class="position-relative panel-title p-2" style="@yield('stylepanel-9');top:0px;">مهارت های تجربی</h5>
            <!-- hidden input -->
            <input type="hidden" name="skillsName1Z"  value="@yield('sn1')" id="skillsName1Z"/>
            <input type="hidden" name="skillsLevel1Z" value="@yield('sl1')" id="skillsLevel1Z"/>
            <input type="hidden" name="skillsName2Z"  value="@yield('sn2')" id="skillsName2Z"/>
            <input type="hidden" name="skillsLevel2Z" value="@yield('sl2')" id="skillsLevel2Z"/>
            <input type="hidden" name="skillsName3Z"  value="@yield('sn3')" id="skillsName3Z"/>
            <input type="hidden" name="skillsLevel3Z" value="@yield('sl3')" id="skillsLevel3Z"/>
            <input type="hidden" name="skillsName4Z"  value="@yield('sn4')" id="skillsName4Z"/>
            <input type="hidden" name="skillsLevel4Z" value="@yield('sl4')" id="skillsLevel4Z"/>
    ...
    <div class="jumbotron w-100 border-2 p-xs-1 p-4 mb-6 br-4 shadow" id="divskills" style="@yield('backpanel-9')">
        ...
        <div class="form-row mt28" id="formskills">
            ...
            <!-- نام مهارت -->
                <div class="form-group float-left m-1 m-md-3 mobile-input" style="min-width: 175px;">
                    ...
                    <input type="text" name="skillsName0" value="@yield('skillsName_0')" id="skillsName0" tabindex="101" size="25"
                ...
                <div class="form-group float-left m-1 m-md-3 mobile-input" style="min-width: 140px;">
                    ...
                    <select type="text" name="skillsLevel0" id="skillsLevel0" tabindex="102"
                        ...
                        <option {{ old('skillsLevel0')=='خیلی‌کم' ? 'selected' : '' }} {{ @$getskill1->SkillsLevel=='خیلی‌کم' ? 'selected' : '' }} value="خیلی‌کم">خیلی‌کم</option>
                        <option {{ old('skillsLevel0')=='کم' ? 'selected' : '' }} {{ @$getskill1->SkillsLevel=='کم' ? 'selected' : '' }} value="کم">‌کم</option>
                        <option {{ old('skillsLevel0')=='متوسط' ? 'selected' : '' }} {{ @$getskill1->SkillsLevel=='متوسط' ? 'selected' : '' }} value="متوسط">متوسط</option>
                        <option {{ old('skillsLevel0')=='زیاد' ? 'selected' : '' }} {{ @$getskill1->SkillsLevel=='زیاد' ? 'selected' : '' }} value="زیاد">زیاد</option>
                        <option {{ old('skillsLevel0')=='خیلی‌زیاد' ? 'selected' : '' }} {{ @$getskill1->SkillsLevel=='خیلی‌زیاد' ? 'selected' : '' }} value="خیلی‌زیاد">خیلی‌زیاد</option>
                    </select>
            </div>
        </div>
        </div>
...
<script src="{{ asset('js/add-s.js') }}"></script>