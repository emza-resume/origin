...
<h5 class="position-relative panel-title p-2 ml-5" style="@yield('stylepanel-4');top:0px;">مهارت زبان</h5>
        <!-- hidden input -->
        <input type="hidden" name="langName1Z" value="@yield('ln1')" id="langName1Z"/>
        <input type="hidden" name="langReading1Z" value="@yield('lr1')" id="langReading1Z"/>
        <input type="hidden" name="langWriting1Z" value="@yield('lw1')" id="langWriting1Z"/>
        <input type="hidden" name="langSpeech1Z" value="@yield('ls1')" id="langSpeech1Z"/>
        <input type="hidden" name="langListening1Z" value="@yield('ll1')" id="langListening1Z"/>
        <input type="hidden" name="langName2Z" value="@yield('ln2')" id="langName2Z"/>
        <input type="hidden" name="langReading2Z" value="@yield('lr2')" id="langReading2Z"/>
        <input type="hidden" name="langWriting2Z" value="@yield('lw2')" id="langWriting2Z"/>
        <input type="hidden" name="langSpeech2Z" value="@yield('ls2')" id="langSpeech2Z"/>
        <input type="hidden" name="langListening2Z" value="@yield('ll2')" id="langListening2Z"/>


        <!-- End input hidden -->
<div class="jumbotron w-100 border-2 p-xs-1 p-4 mb-6 br-4 shadow" id="divlang" style="@yield('backpanel-4')">
    ...
    <div class="form-row mt28" id="formlang0">
        ...
        <div class="form-group float-left m-1 m-md-3 mobile-input" style="min-width: 220px;">
            ...
            <input type="text" name="langName0" list="langname0" id="langName0" value="@yield('langName_0')" tabindex="33" size="20"  class="form-control border-purple" required>
        ...
        <div class="form-group float-left m-1 m-md-3 mobile-input" style="min-width: 220px;">
                ...
                <select name="langReading0" id="langReading0" tabindex="34"  class="form-control border-purple" required>
                    ...
                    <option {{ old('langReading0')=='1' ? 'selected' : '' }} {{ @$getlang1->LangReadingskills=='1' ? 'selected' : '' }} value="1">خیلی کم</option>
                    <option {{ old('langReading0')=='2' ? 'selected' : '' }} {{ @$getlang1->LangReadingskills=='2' ? 'selected' : '' }} value="2">کم</option>
                    <option {{ old('langReading0')=='3' ? 'selected' : '' }} {{ @$getlang1->LangReadingskills=='3' ? 'selected' : '' }} value="3">متوسط</option>
                    <option {{ old('langReading0')=='4' ? 'selected' : '' }} {{ @$getlang1->LangReadingskills=='4' ? 'selected' : '' }} value="4">زیاد</option>
                    <option {{ old('langReading0')=='5' ? 'selected' : '' }} {{ @$getlang1->LangReadingskills=='5' ? 'selected' : '' }} value="5">خیلی زیاد</option>
            </select>
        </div>
        ...
        <div class="form-group float-left m-1 m-md-3 mobile-input" style="min-width: 220px;">
                ...
                <select name="langWriting0" id="langWriting0" tabindex="35"  class="form-control border-purple" required>
                    <option selected value="">انتخاب کنید</option>
                    <option {{ old('langWriting0')=='1' ? 'selected' : '' }} {{ @$getlang1->LangWritingskills=='1' ? 'selected' : '' }} value="1">خیلی کم</option>
                    <option {{ old('langWriting0')=='2' ? 'selected' : '' }} {{ @$getlang1->LangWritingskills=='2' ? 'selected' : '' }} value="2">کم</option>
                    <option {{ old('langWriting0')=='3' ? 'selected' : '' }} {{ @$getlang1->LangWritingskills=='3' ? 'selected' : '' }} value="3">متوسط</option>
                    <option {{ old('langWriting0')=='4' ? 'selected' : '' }} {{ @$getlang1->LangWritingskills=='4' ? 'selected' : '' }} value="4">زیاد</option>
                    <option {{ old('langWriting0')=='5' ? 'selected' : '' }} {{ @$getlang1->LangWritingskills=='5' ? 'selected' : '' }} value="5">خیلی زیاد</option>
            </select>
        </div>
        ...
        <div class="form-group float-left m-1 m-md-3 mobile-input" style="min-width: 220px;">
                ...
                <select name="langSpeech0" id="langSpeech0" tabindex="36"  class="form-control border-purple" required>
                    <option selected value="">انتخاب کنید</option>
                    <option {{ old('langSpeech0')=='1' ? 'selected' : '' }} {{ @$getlang1->LangTalkingskills=='1' ? 'selected' : '' }} value="1">خیلی کم</option>
                    <option {{ old('langSpeech0')=='2' ? 'selected' : '' }} {{ @$getlang1->LangTalkingskills=='2' ? 'selected' : '' }} value="2">کم</option>
                    <option {{ old('langSpeech0')=='3' ? 'selected' : '' }} {{ @$getlang1->LangTalkingskills=='3' ? 'selected' : '' }} value="3">متوسط</option>
                    <option {{ old('langSpeech0')=='4' ? 'selected' : '' }} {{ @$getlang1->LangTalkingskills=='4' ? 'selected' : '' }} value="4">زیاد</option>
                    <option {{ old('langSpeech0')=='5' ? 'selected' : '' }} {{ @$getlang1->LangTalkingskills=='5' ? 'selected' : '' }} value="5">خیلی زیاد</option>
            </select>
        </div>
        ...
        <div class="form-group float-left m-1 m-md-3 mobile-input" style="min-width: 220px;">
                ...
                <select name="langListening0" id="langListening0" tabindex="37"  class="form-control border-purple" required>
                    <option selected value="">انتخاب کنید</option>
                    <option {{ old('langListening0')=='1' ? 'selected' : '' }} {{ @$getlang1->LangListeningskills=='1' ? 'selected' : '' }} value="1">خیلی کم</option>
                    <option {{ old('langListening0')=='2' ? 'selected' : '' }} {{ @$getlang1->LangListeningskills=='2' ? 'selected' : '' }} value="2">کم</option>
                    <option {{ old('langListening0')=='3' ? 'selected' : '' }} {{ @$getlang1->LangListeningskills=='3' ? 'selected' : '' }} value="3">متوسط</option>
                    <option {{ old('langListening0')=='4' ? 'selected' : '' }} {{ @$getlang1->LangListeningskills=='4' ? 'selected' : '' }} value="4">زیاد</option>
                    <option {{ old('langListening0')=='5' ? 'selected' : '' }} {{ @$getlang1->LangListeningskills=='5' ? 'selected' : '' }} value="5">خیلی زیاد</option>
            </select>
        </div>
...
<script src="{{ asset('js/add-l.js') }}"></script>
