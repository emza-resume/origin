@include('component.resumex.name')

@include('component.resumex.gender')

@include('component.resumex.birthdate')

@include('component.resumex.call')

<div class="d-flex m-5" style="position: relative;top: -35px;">
    <div class="p-2 flex-fill">
        @include('component.resumex.academic')
        <div class="p-2 flex-fill">
            @include('component.resumex.cources')
            <div class="p-2 flex-fill">
                @include('component.resumex.work')
            </div>
        </div>
        <div class="d-flex m-5" style="position: relative;top: -75px;">
            <div class="p-2 flex-fill">
                @include('component.resumex.lang')

                @include('component.resumex.thesis')

            </div>
            <div class="p-2 flex-fill">

                @include('component.resumex.project')

            </div>

        </div>

        @include('component.resumex.skill')
...
<script>
    $(document).ready(function () {
        ...
        if (sextype == 'زن') {
            ...
            $("#avatarx").attr("src", "{{ asset('img/avatar/woman.png') }}");
        ...
        if (sextype == 'مرد') {
            ...
            $("#avatarx").attr("src", "{{ asset('img/avatar/man.png') }}");
