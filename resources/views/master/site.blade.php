        ...
        <header class="header" style="right:0">
            <div class="header-content">
                <div class="profile-picture-block">
                    <div class="my-photo">
                        <img src="{{ asset('img/my1373.png') }}" class="img-fluid" style="box-sizing: border-box;width:70px" alt="Reza Ahmadi">
                    </div>
                </div>
                <!-- Header Head -->
...
"> رزومه&nbsp;&nbsp;<img width="20" height="20" src="{{ asset('img/site/curriculum.png') }}"></a></li>
        ...
        <div class="responsive-header">
            <div class="responsive-header-name">
                <img class="responsive-logo" src="{{ asset('img/my1373.png') }}" /> رضا احمدی </div>
